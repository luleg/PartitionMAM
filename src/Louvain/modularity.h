...
class Modularity: public Quality {
 public:
  ...
  std::vector<long double> in, tot; // used to compute the quality participation of each community
  long double alpha;

  Modularity(Graph & gr, long double al);
  ~Modularity();
